...
import (
	...
	"hyacine-server/internal/gameserver"
	"hyacine-server/internal/gameserver/admin"
	"hyacine-server/internal/gameserver/database"
	"hyacine-server/internal/gameserver/program"
...
func main() {
	...
	gameServer := gameserver.New(cfg.GameServer.Addr, gameserver.Options{
	...
	reloadFn = func() error {
		...
		gameServer.UpdateOptions(gameserver.Options{
