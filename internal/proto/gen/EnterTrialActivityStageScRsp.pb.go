...
const file_EnterTrialActivityStageScRsp_proto_rawDesc = "" +
	"\n" +
	"\"EnterTrialActivityStageScRsp.proto\x12\x13emu.lunarcore.proto\x1a\x15SceneBattleInfo.proto\"\x7f\n" +
	"\x1cEnterTrialActivityStageScRsp\x12E\n" +
	"\vbattle_info\x18\x05 \x01(\v2$.emu.lunarcore.proto.SceneBattleInfoR\n" +
	"battleInfo\x12\x18\n" +
...
var (
	...
	file_EnterTrialActivityStageScRsp_proto_rawDescData []byte
)

func file_EnterTrialActivityStageScRsp_proto_rawDescGZIP() []byte {
	file_EnterTrialActivityStageScRsp_proto_rawDescOnce.Do(func() {
		file_EnterTrialActivityStageScRsp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_EnterTrialActivityStageScRsp_proto_rawDesc), len(file_EnterTrialActivityStageScRsp_proto_rawDesc)))
	})
...
var file_EnterTrialActivityStageScRsp_proto_goTypes = []any{
	(*EnterTrialActivityStageScRsp)(nil), // 0: emu.lunarcore.proto.EnterTrialActivityStageScRsp
	(*SceneBattleInfo)(nil),              // 1: emu.lunarcore.proto.SceneBattleInfo
}
var file_EnterTrialActivityStageScRsp_proto_depIdxs = []int32{
	1, // 0: emu.lunarcore.proto.EnterTrialActivityStageScRsp.battle_info:type_name -> emu.lunarcore.proto.SceneBattleInfo
...
func file_EnterTrialActivityStageScRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_EnterTrialActivityStageScRsp_proto_rawDesc), len(file_EnterTrialActivityStageScRsp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
