...
const file_TakeRollShopRewardScRsp_proto_rawDesc = "" +
	"\n" +
	"\x1dTakeRollShopRewardScRsp.proto\x12\x13emu.lunarcore.proto\x1a\x0eItemList.proto\"\xab\x01\n" +
	"\x17TakeRollShopRewardScRsp\x125\n" +
	"\x06reward\x18\x01 \x01(\v2\x1d.emu.lunarcore.proto.ItemListR\x06reward\x12\x1d\n" +
	"\n" +
	"group_type\x18\x05 \x01(\rR\tgroupType\x12 \n" +
	"\froll_shop_id\x18\t \x01(\rR\n" +
	"rollShopId\x12\x18\n" +
...
var (
	...
	file_TakeRollShopRewardScRsp_proto_rawDescData []byte
)

func file_TakeRollShopRewardScRsp_proto_rawDescGZIP() []byte {
	file_TakeRollShopRewardScRsp_proto_rawDescOnce.Do(func() {
		file_TakeRollShopRewardScRsp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_TakeRollShopRewardScRsp_proto_rawDesc), len(file_TakeRollShopRewardScRsp_proto_rawDesc)))
	})
...
var file_TakeRollShopRewardScRsp_proto_goTypes = []any{
	(*TakeRollShopRewardScRsp)(nil), // 0: emu.lunarcore.proto.TakeRollShopRewardScRsp
	(*ItemList)(nil),                // 1: emu.lunarcore.proto.ItemList
}
var file_TakeRollShopRewardScRsp_proto_depIdxs = []int32{
	1, // 0: emu.lunarcore.proto.TakeRollShopRewardScRsp.reward:type_name -> emu.lunarcore.proto.ItemList
...
func file_TakeRollShopRewardScRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_TakeRollShopRewardScRsp_proto_rawDesc), len(file_TakeRollShopRewardScRsp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
