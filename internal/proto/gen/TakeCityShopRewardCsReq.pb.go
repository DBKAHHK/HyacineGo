...
const file_TakeCityShopRewardCsReq_proto_rawDesc = "" +
	"\n" +
	"\x1dTakeCityShopRewardCsReq.proto\x12\x13emu.lunarcore.proto\"H\n" +
	"\x17TakeCityShopRewardCsReq\x12\x17\n" +
	"\ashop_id\x18\x05 \x01(\rR\x06shopId\x12\x14\n" +
...
var (
	...
	file_TakeCityShopRewardCsReq_proto_rawDescData []byte
)

func file_TakeCityShopRewardCsReq_proto_rawDescGZIP() []byte {
	file_TakeCityShopRewardCsReq_proto_rawDescOnce.Do(func() {
		file_TakeCityShopRewardCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_TakeCityShopRewardCsReq_proto_rawDesc), len(file_TakeCityShopRewardCsReq_proto_rawDesc)))
	})
...
var file_TakeCityShopRewardCsReq_proto_goTypes = []any{
	(*TakeCityShopRewardCsReq)(nil), // 0: emu.lunarcore.proto.TakeCityShopRewardCsReq
}
...
func file_TakeCityShopRewardCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_TakeCityShopRewardCsReq_proto_rawDesc), len(file_TakeCityShopRewardCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
