...
func (x *ChallengeAvatarInfo) GetBLEHKKONEHP() uint32 {
	if x != nil {
...
const file_ChallengeAvatarInfo_proto_rawDesc = "" +
	"\n" +
	"\x19ChallengeAvatarInfo.proto\x12\x13emu.lunarcore.proto\x1a\x10AvatarType.proto\"\xb5\x01\n" +
	"\x13ChallengeAvatarInfo\x12@\n" +
	"\vavatar_type\x18\x01 \x01(\x0e2\x1f.emu.lunarcore.proto.AvatarTypeR\n" +
	"avatarType\x12 \n" +
	"\vBLEHKKONEHP\x18\x04 \x01(\rR\vBLEHKKONEHP\x12\x0e\n" +
	"\x02id\x18\x06 \x01(\rR\x02id\x12\x14\n" +
	"\x05level\x18\x0e \x01(\rR\x05level\x12\x14\n" +
...
var (
	...
	file_ChallengeAvatarInfo_proto_rawDescData []byte
)

func file_ChallengeAvatarInfo_proto_rawDescGZIP() []byte {
	file_ChallengeAvatarInfo_proto_rawDescOnce.Do(func() {
		file_ChallengeAvatarInfo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ChallengeAvatarInfo_proto_rawDesc), len(file_ChallengeAvatarInfo_proto_rawDesc)))
	})
...
var file_ChallengeAvatarInfo_proto_goTypes = []any{
	(*ChallengeAvatarInfo)(nil), // 0: emu.lunarcore.proto.ChallengeAvatarInfo
	(AvatarType)(0),             // 1: emu.lunarcore.proto.AvatarType
}
var file_ChallengeAvatarInfo_proto_depIdxs = []int32{
	1, // 0: emu.lunarcore.proto.ChallengeAvatarInfo.avatar_type:type_name -> emu.lunarcore.proto.AvatarType
...
func file_ChallengeAvatarInfo_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ChallengeAvatarInfo_proto_rawDesc), len(file_ChallengeAvatarInfo_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
