...
type InteractTreasureDungeonGridScRsp struct {
	...
	ABJIFKGCALM   *GHDOCJAMEIF           `protobuf:"bytes,11,opt,name=ABJIFKGCALM,proto3" json:"ABJIFKGCALM,omitempty"`
...
func (x *InteractTreasureDungeonGridScRsp) GetABJIFKGCALM() *GHDOCJAMEIF {
	if x != nil {
...
const file_InteractTreasureDungeonGridScRsp_proto_rawDesc = "" +
	"\n" +
	"&InteractTreasureDungeonGridScRsp.proto\x12\x13emu.lunarcore.proto\x1a\x11GHDOCJAMEIF.proto\"\x80\x01\n" +
	" InteractTreasureDungeonGridScRsp\x12\x18\n" +
	"\aretcode\x18\b \x01(\rR\aretcode\x12B\n" +
	"\vABJIFKGCALM\x18\v \x01(\v2 .emu.lunarcore.proto.GHDOCJAMEIFR\vABJIFKGCALMB>\n" +
...
var (
	...
	file_InteractTreasureDungeonGridScRsp_proto_rawDescData []byte
)
...
func file_InteractTreasureDungeonGridScRsp_proto_rawDescGZIP() []byte {
	file_InteractTreasureDungeonGridScRsp_proto_rawDescOnce.Do(func() {
		file_InteractTreasureDungeonGridScRsp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_InteractTreasureDungeonGridScRsp_proto_rawDesc), len(file_InteractTreasureDungeonGridScRsp_proto_rawDesc)))
	})
...
var file_InteractTreasureDungeonGridScRsp_proto_goTypes = []any{
	(*InteractTreasureDungeonGridScRsp)(nil), // 0: emu.lunarcore.proto.InteractTreasureDungeonGridScRsp
	(*GHDOCJAMEIF)(nil),                      // 1: emu.lunarcore.proto.GHDOCJAMEIF
}
var file_InteractTreasureDungeonGridScRsp_proto_depIdxs = []int32{
	1, // 0: emu.lunarcore.proto.InteractTreasureDungeonGridScRsp.ABJIFKGCALM:type_name -> emu.lunarcore.proto.GHDOCJAMEIF
...
func file_InteractTreasureDungeonGridScRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_InteractTreasureDungeonGridScRsp_proto_rawDesc), len(file_InteractTreasureDungeonGridScRsp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
