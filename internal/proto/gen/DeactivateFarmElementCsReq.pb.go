...
const file_DeactivateFarmElementCsReq_proto_rawDesc = "" +
	"\n" +
	" DeactivateFarmElementCsReq.proto\x12\x13emu.lunarcore.proto\"9\n" +
	"\x1aDeactivateFarmElementCsReq\x12\x1b\n" +
	"\tentity_id\x18\t \x01(\rR\bentityIdB>\n" +
...
var (
	...
	file_DeactivateFarmElementCsReq_proto_rawDescData []byte
)

func file_DeactivateFarmElementCsReq_proto_rawDescGZIP() []byte {
	file_DeactivateFarmElementCsReq_proto_rawDescOnce.Do(func() {
		file_DeactivateFarmElementCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_DeactivateFarmElementCsReq_proto_rawDesc), len(file_DeactivateFarmElementCsReq_proto_rawDesc)))
	})
...
var file_DeactivateFarmElementCsReq_proto_goTypes = []any{
	(*DeactivateFarmElementCsReq)(nil), // 0: emu.lunarcore.proto.DeactivateFarmElementCsReq
}
...
func file_DeactivateFarmElementCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_DeactivateFarmElementCsReq_proto_rawDesc), len(file_DeactivateFarmElementCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
