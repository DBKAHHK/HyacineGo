...
const file_FinishPerformSectionIdCsReq_proto_rawDesc = "" +
	"\n" +
	"!FinishPerformSectionIdCsReq.proto\x12\x13emu.lunarcore.proto\x1a\x11MessageItem.proto\"{\n" +
	"\x1bFinishPerformSectionIdCsReq\x12=\n" +
...
var (
	...
	file_FinishPerformSectionIdCsReq_proto_rawDescData []byte
)

func file_FinishPerformSectionIdCsReq_proto_rawDescGZIP() []byte {
	file_FinishPerformSectionIdCsReq_proto_rawDescOnce.Do(func() {
		file_FinishPerformSectionIdCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_FinishPerformSectionIdCsReq_proto_rawDesc), len(file_FinishPerformSectionIdCsReq_proto_rawDesc)))
	})
...
var file_FinishPerformSectionIdCsReq_proto_goTypes = []any{
	(*FinishPerformSectionIdCsReq)(nil), // 0: emu.lunarcore.proto.FinishPerformSectionIdCsReq
	(*MessageItem)(nil),                 // 1: emu.lunarcore.proto.MessageItem
}
var file_FinishPerformSectionIdCsReq_proto_depIdxs = []int32{
	1, // 0: emu.lunarcore.proto.FinishPerformSectionIdCsReq.item_list:type_name -> emu.lunarcore.proto.MessageItem
...
func file_FinishPerformSectionIdCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_FinishPerformSectionIdCsReq_proto_rawDesc), len(file_FinishPerformSectionIdCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
