...
type GetRollShopInfoScRsp struct {
	...
	ShopGroupIdList []uint32               `protobuf:"varint,12,rep,packed,name=shop_group_id_list,json=shopGroupIdList,proto3" json:"shop_group_id_list,omitempty"`
...
const file_GetRollShopInfoScRsp_proto_rawDesc = "" +
	"\n" +
	"\x1aGetRollShopInfoScRsp.proto\x12\x13emu.lunarcore.proto\"\xa2\x01\n" +
	"\x14GetRollShopInfoScRsp\x12!\n" +
	"\fgacha_random\x18\x01 \x01(\rR\vgachaRandom\x12 \n" +
	"\froll_shop_id\x18\a \x01(\rR\n" +
	"rollShopId\x12\x18\n" +
	"\aretcode\x18\v \x01(\rR\aretcode\x12+\n" +
	"\x12shop_group_id_list\x18\f \x03(\rR\x0fshopGroupIdListB>\n" +
...
var (
	...
	file_GetRollShopInfoScRsp_proto_rawDescData []byte
)

func file_GetRollShopInfoScRsp_proto_rawDescGZIP() []byte {
	file_GetRollShopInfoScRsp_proto_rawDescOnce.Do(func() {
		file_GetRollShopInfoScRsp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_GetRollShopInfoScRsp_proto_rawDesc), len(file_GetRollShopInfoScRsp_proto_rawDesc)))
	})
...
var file_GetRollShopInfoScRsp_proto_goTypes = []any{
	(*GetRollShopInfoScRsp)(nil), // 0: emu.lunarcore.proto.GetRollShopInfoScRsp
}
...
func file_GetRollShopInfoScRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_GetRollShopInfoScRsp_proto_rawDesc), len(file_GetRollShopInfoScRsp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
