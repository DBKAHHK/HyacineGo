...
const file_TakeOffEquipmentCsReq_proto_rawDesc = "" +
	"\n" +
	"\x1bTakeOffEquipmentCsReq.proto\x12\x13emu.lunarcore.proto\"4\n" +
...
var (
	...
	file_TakeOffEquipmentCsReq_proto_rawDescData []byte
)

func file_TakeOffEquipmentCsReq_proto_rawDescGZIP() []byte {
	file_TakeOffEquipmentCsReq_proto_rawDescOnce.Do(func() {
		file_TakeOffEquipmentCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_TakeOffEquipmentCsReq_proto_rawDesc), len(file_TakeOffEquipmentCsReq_proto_rawDesc)))
	})
...
var file_TakeOffEquipmentCsReq_proto_goTypes = []any{
	(*TakeOffEquipmentCsReq)(nil), // 0: emu.lunarcore.proto.TakeOffEquipmentCsReq
}
...
func file_TakeOffEquipmentCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_TakeOffEquipmentCsReq_proto_rawDesc), len(file_TakeOffEquipmentCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
