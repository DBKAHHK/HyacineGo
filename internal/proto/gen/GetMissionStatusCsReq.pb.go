...
type GetMissionStatusCsReq struct {
	...
	MainMissionIdList []uint32               `protobuf:"varint,15,rep,packed,name=main_mission_id_list,json=mainMissionIdList,proto3" json:"main_mission_id_list,omitempty"`
...
const file_GetMissionStatusCsReq_proto_rawDesc = "" +
	"\n" +
	"\x1bGetMissionStatusCsReq.proto\x12\x13emu.lunarcore.proto\"w\n" +
	"\x15GetMissionStatusCsReq\x12-\n" +
	"\x13sub_mission_id_list\x18\a \x03(\rR\x10subMissionIdList\x12/\n" +
	"\x14main_mission_id_list\x18\x0f \x03(\rR\x11mainMissionIdListB>\n" +
...
var (
	...
	file_GetMissionStatusCsReq_proto_rawDescData []byte
)

func file_GetMissionStatusCsReq_proto_rawDescGZIP() []byte {
	file_GetMissionStatusCsReq_proto_rawDescOnce.Do(func() {
		file_GetMissionStatusCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_GetMissionStatusCsReq_proto_rawDesc), len(file_GetMissionStatusCsReq_proto_rawDesc)))
	})
...
var file_GetMissionStatusCsReq_proto_goTypes = []any{
	(*GetMissionStatusCsReq)(nil), // 0: emu.lunarcore.proto.GetMissionStatusCsReq
}
...
func file_GetMissionStatusCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_GetMissionStatusCsReq_proto_rawDesc), len(file_GetMissionStatusCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
