...
const file_SetClientPausedCsReq_proto_rawDesc = "" +
	"\n" +
	"\x1aSetClientPausedCsReq.proto\x12\x13emu.lunarcore.proto\".\n" +
	"\x14SetClientPausedCsReq\x12\x16\n" +
	"\x06paused\x18\x0e \x01(\bR\x06pausedB>\n" +
...
var (
	...
	file_SetClientPausedCsReq_proto_rawDescData []byte
)

func file_SetClientPausedCsReq_proto_rawDescGZIP() []byte {
	file_SetClientPausedCsReq_proto_rawDescOnce.Do(func() {
		file_SetClientPausedCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SetClientPausedCsReq_proto_rawDesc), len(file_SetClientPausedCsReq_proto_rawDesc)))
	})
...
var file_SetClientPausedCsReq_proto_goTypes = []any{
	(*SetClientPausedCsReq)(nil), // 0: emu.lunarcore.proto.SetClientPausedCsReq
}
...
func file_SetClientPausedCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SetClientPausedCsReq_proto_rawDesc), len(file_SetClientPausedCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
