...
const file_DeathSource_proto_rawDesc = "" +
	"\n" +
	"\x11DeathSource.proto\x12\x13emu.lunarcore.proto*P\n" +
	"\vDeathSource\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\x14\n" +
	"\x10KILLED_BY_OTHERS\x10\x01\x12\x12\n" +
	"\x0eKILLED_BY_SELF\x10\x02\x12\n" +
	"\n" +
	"\x06ESCAPE\x10\x03B>\n" +
...
var (
	...
	file_DeathSource_proto_rawDescData []byte
)

func file_DeathSource_proto_rawDescGZIP() []byte {
	file_DeathSource_proto_rawDescOnce.Do(func() {
		file_DeathSource_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_DeathSource_proto_rawDesc), len(file_DeathSource_proto_rawDesc)))
	})
	return file_DeathSource_proto_rawDescData
}

var file_DeathSource_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_DeathSource_proto_goTypes = []any{
	(DeathSource)(0), // 0: emu.lunarcore.proto.DeathSource
}
...
func file_DeathSource_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_DeathSource_proto_rawDesc), len(file_DeathSource_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
