...
type BatchGetQuestDataScRsp struct {
	...
	QuestList     []*Quest               `protobuf:"bytes,8,rep,name=quest_list,json=questList,proto3" json:"quest_list,omitempty"`
...
const file_BatchGetQuestDataScRsp_proto_rawDesc = "" +
	"\n" +
	"\x1cBatchGetQuestDataScRsp.proto\x12\x13emu.lunarcore.proto\x1a\vQuest.proto\"m\n" +
	"\x16BatchGetQuestDataScRsp\x129\n" +
	"\n" +
	"quest_list\x18\b \x03(\v2\x1a.emu.lunarcore.proto.QuestR\tquestList\x12\x18\n" +
...
var (
	...
	file_BatchGetQuestDataScRsp_proto_rawDescData []byte
)

func file_BatchGetQuestDataScRsp_proto_rawDescGZIP() []byte {
	file_BatchGetQuestDataScRsp_proto_rawDescOnce.Do(func() {
		file_BatchGetQuestDataScRsp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_BatchGetQuestDataScRsp_proto_rawDesc), len(file_BatchGetQuestDataScRsp_proto_rawDesc)))
	})
...
var file_BatchGetQuestDataScRsp_proto_goTypes = []any{
	(*BatchGetQuestDataScRsp)(nil), // 0: emu.lunarcore.proto.BatchGetQuestDataScRsp
	(*Quest)(nil),                  // 1: emu.lunarcore.proto.Quest
}
var file_BatchGetQuestDataScRsp_proto_depIdxs = []int32{
	1, // 0: emu.lunarcore.proto.BatchGetQuestDataScRsp.quest_list:type_name -> emu.lunarcore.proto.Quest
...
func file_BatchGetQuestDataScRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_BatchGetQuestDataScRsp_proto_rawDesc), len(file_BatchGetQuestDataScRsp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
