...
type GameplayCounterCountDownCsReq struct {
	...
	GKBGFKOLICB   uint32                 `protobuf:"varint,12,opt,name=GKBGFKOLICB,proto3" json:"GKBGFKOLICB,omitempty"`
...
func (x *GameplayCounterCountDownCsReq) GetGKBGFKOLICB() uint32 {
	if x != nil {
...
const file_GameplayCounterCountDownCsReq_proto_rawDesc = "" +
	"\n" +
	"#GameplayCounterCountDownCsReq.proto\x12\x13emu.lunarcore.proto\"^\n" +
	"\x1dGameplayCounterCountDownCsReq\x12\x1b\n" +
	"\tcur_times\x18\x03 \x01(\rR\bcurTimes\x12 \n" +
	"\vGKBGFKOLICB\x18\f \x01(\rR\vGKBGFKOLICBB>\n" +
...
var (
	...
	file_GameplayCounterCountDownCsReq_proto_rawDescData []byte
)
...
func file_GameplayCounterCountDownCsReq_proto_rawDescGZIP() []byte {
	file_GameplayCounterCountDownCsReq_proto_rawDescOnce.Do(func() {
		file_GameplayCounterCountDownCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_GameplayCounterCountDownCsReq_proto_rawDesc), len(file_GameplayCounterCountDownCsReq_proto_rawDesc)))
	})
...
var file_GameplayCounterCountDownCsReq_proto_goTypes = []any{
	(*GameplayCounterCountDownCsReq)(nil), // 0: emu.lunarcore.proto.GameplayCounterCountDownCsReq
}
...
func file_GameplayCounterCountDownCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_GameplayCounterCountDownCsReq_proto_rawDesc), len(file_GameplayCounterCountDownCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
