...
const file_SetHeadIconCsReq_proto_rawDesc = "" +
	"\n" +
	"\x16SetHeadIconCsReq.proto\x12\x13emu.lunarcore.proto\"\"\n" +
...
var (
	...
	file_SetHeadIconCsReq_proto_rawDescData []byte
)

func file_SetHeadIconCsReq_proto_rawDescGZIP() []byte {
	file_SetHeadIconCsReq_proto_rawDescOnce.Do(func() {
		file_SetHeadIconCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SetHeadIconCsReq_proto_rawDesc), len(file_SetHeadIconCsReq_proto_rawDesc)))
	})
	return file_SetHeadIconCsReq_proto_rawDescData
}

var file_SetHeadIconCsReq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_SetHeadIconCsReq_proto_goTypes = []any{
	(*SetHeadIconCsReq)(nil), // 0: emu.lunarcore.proto.SetHeadIconCsReq
}
...
func file_SetHeadIconCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SetHeadIconCsReq_proto_rawDesc), len(file_SetHeadIconCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
