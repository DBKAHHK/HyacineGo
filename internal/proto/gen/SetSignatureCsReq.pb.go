...
const file_SetSignatureCsReq_proto_rawDesc = "" +
	"\n" +
	"\x17SetSignatureCsReq.proto\x12\x13emu.lunarcore.proto\"1\n" +
...
var (
	...
	file_SetSignatureCsReq_proto_rawDescData []byte
)

func file_SetSignatureCsReq_proto_rawDescGZIP() []byte {
	file_SetSignatureCsReq_proto_rawDescOnce.Do(func() {
		file_SetSignatureCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SetSignatureCsReq_proto_rawDesc), len(file_SetSignatureCsReq_proto_rawDesc)))
	})
	return file_SetSignatureCsReq_proto_rawDescData
}

var file_SetSignatureCsReq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_SetSignatureCsReq_proto_goTypes = []any{
	(*SetSignatureCsReq)(nil), // 0: emu.lunarcore.proto.SetSignatureCsReq
}
...
func file_SetSignatureCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SetSignatureCsReq_proto_rawDesc), len(file_SetSignatureCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
