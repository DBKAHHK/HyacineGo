...
type MissionGroupWarnScNotify struct {
	...
	GroupIdList   []uint32               `protobuf:"varint,11,rep,packed,name=group_id_list,json=groupIdList,proto3" json:"group_id_list,omitempty"`
...
const file_MissionGroupWarnScNotify_proto_rawDesc = "" +
	"\n" +
	"\x1eMissionGroupWarnScNotify.proto\x12\x13emu.lunarcore.proto\">\n" +
	"\x18MissionGroupWarnScNotify\x12\"\n" +
	"\rgroup_id_list\x18\v \x03(\rR\vgroupIdListB>\n" +
...
var (
	...
	file_MissionGroupWarnScNotify_proto_rawDescData []byte
)

func file_MissionGroupWarnScNotify_proto_rawDescGZIP() []byte {
	file_MissionGroupWarnScNotify_proto_rawDescOnce.Do(func() {
		file_MissionGroupWarnScNotify_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_MissionGroupWarnScNotify_proto_rawDesc), len(file_MissionGroupWarnScNotify_proto_rawDesc)))
	})
...
var file_MissionGroupWarnScNotify_proto_goTypes = []any{
	(*MissionGroupWarnScNotify)(nil), // 0: emu.lunarcore.proto.MissionGroupWarnScNotify
}
...
func file_MissionGroupWarnScNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_MissionGroupWarnScNotify_proto_rawDesc), len(file_MissionGroupWarnScNotify_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
