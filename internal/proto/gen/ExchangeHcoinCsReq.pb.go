...
const file_ExchangeHcoinCsReq_proto_rawDesc = "" +
	"\n" +
	"\x18ExchangeHcoinCsReq.proto\x12\x13emu.lunarcore.proto\"&\n" +
...
var (
	...
	file_ExchangeHcoinCsReq_proto_rawDescData []byte
)

func file_ExchangeHcoinCsReq_proto_rawDescGZIP() []byte {
	file_ExchangeHcoinCsReq_proto_rawDescOnce.Do(func() {
		file_ExchangeHcoinCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ExchangeHcoinCsReq_proto_rawDesc), len(file_ExchangeHcoinCsReq_proto_rawDesc)))
	})
	return file_ExchangeHcoinCsReq_proto_rawDescData
}

var file_ExchangeHcoinCsReq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ExchangeHcoinCsReq_proto_goTypes = []any{
	(*ExchangeHcoinCsReq)(nil), // 0: emu.lunarcore.proto.ExchangeHcoinCsReq
}
...
func file_ExchangeHcoinCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ExchangeHcoinCsReq_proto_rawDesc), len(file_ExchangeHcoinCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
