...
const file_FightHeartBeatScRsp_proto_rawDesc = "" +
	"\n" +
	"\x19FightHeartBeatScRsp.proto\x12\x13emu.lunarcore.proto\"{\n" +
	"\x13FightHeartBeatScRsp\x12$\n" +
	"\x0eserver_time_ms\x18\x06 \x01(\x04R\fserverTimeMs\x12$\n" +
	"\x0eclient_time_ms\x18\b \x01(\x04R\fclientTimeMs\x12\x18\n" +
...
var (
	...
	file_FightHeartBeatScRsp_proto_rawDescData []byte
)

func file_FightHeartBeatScRsp_proto_rawDescGZIP() []byte {
	file_FightHeartBeatScRsp_proto_rawDescOnce.Do(func() {
		file_FightHeartBeatScRsp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_FightHeartBeatScRsp_proto_rawDesc), len(file_FightHeartBeatScRsp_proto_rawDesc)))
	})
...
var file_FightHeartBeatScRsp_proto_goTypes = []any{
	(*FightHeartBeatScRsp)(nil), // 0: emu.lunarcore.proto.FightHeartBeatScRsp
}
...
func file_FightHeartBeatScRsp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_FightHeartBeatScRsp_proto_rawDesc), len(file_FightHeartBeatScRsp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
