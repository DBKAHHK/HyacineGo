...
const file_BasicModuleSync_proto_rawDesc = "" +
	"\n" +
	"\x15BasicModuleSync.proto\x12\x13emu.lunarcore.proto\"h\n" +
	"\x0fBasicModuleSync\x12\x18\n" +
	"\astamina\x18\b \x01(\rR\astamina\x12;\n" +
	"\x1aweek_cocoon_finished_count\x18\x0e \x01(\rR\x17weekCocoonFinishedCountB>\n" +
...
var (
	...
	file_BasicModuleSync_proto_rawDescData []byte
)

func file_BasicModuleSync_proto_rawDescGZIP() []byte {
	file_BasicModuleSync_proto_rawDescOnce.Do(func() {
		file_BasicModuleSync_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_BasicModuleSync_proto_rawDesc), len(file_BasicModuleSync_proto_rawDesc)))
	})
	return file_BasicModuleSync_proto_rawDescData
}

var file_BasicModuleSync_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_BasicModuleSync_proto_goTypes = []any{
	(*BasicModuleSync)(nil), // 0: emu.lunarcore.proto.BasicModuleSync
}
...
func file_BasicModuleSync_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_BasicModuleSync_proto_rawDesc), len(file_BasicModuleSync_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
