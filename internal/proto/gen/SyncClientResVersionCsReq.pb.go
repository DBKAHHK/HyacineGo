...
type SyncClientResVersionCsReq struct {
	...
	ClientResVersion uint32                 `protobuf:"varint,5,opt,name=client_res_version,json=clientResVersion,proto3" json:"client_res_version,omitempty"`
...
const file_SyncClientResVersionCsReq_proto_rawDesc = "" +
	"\n" +
	"\x1fSyncClientResVersionCsReq.proto\x12\x13emu.lunarcore.proto\"I\n" +
	"\x19SyncClientResVersionCsReq\x12,\n" +
	"\x12client_res_version\x18\x05 \x01(\rR\x10clientResVersionB>\n" +
...
var (
	...
	file_SyncClientResVersionCsReq_proto_rawDescData []byte
)

func file_SyncClientResVersionCsReq_proto_rawDescGZIP() []byte {
	file_SyncClientResVersionCsReq_proto_rawDescOnce.Do(func() {
		file_SyncClientResVersionCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SyncClientResVersionCsReq_proto_rawDesc), len(file_SyncClientResVersionCsReq_proto_rawDesc)))
	})
...
var file_SyncClientResVersionCsReq_proto_goTypes = []any{
	(*SyncClientResVersionCsReq)(nil), // 0: emu.lunarcore.proto.SyncClientResVersionCsReq
}
...
func file_SyncClientResVersionCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SyncClientResVersionCsReq_proto_rawDesc), len(file_SyncClientResVersionCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
