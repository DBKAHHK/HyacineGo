...
const file_SetAssistAvatarCsReq_proto_rawDesc = "" +
	"\n" +
	"\x1aSetAssistAvatarCsReq.proto\x12\x13emu.lunarcore.proto\"Y\n" +
	"\x14SetAssistAvatarCsReq\x12$\n" +
	"\x0eavatar_id_list\x18\t \x03(\rR\favatarIdList\x12\x1b\n" +
	"\tavatar_id\x18\n" +
	" \x01(\rR\bavatarIdB>\n" +
...
var (
	...
	file_SetAssistAvatarCsReq_proto_rawDescData []byte
)

func file_SetAssistAvatarCsReq_proto_rawDescGZIP() []byte {
	file_SetAssistAvatarCsReq_proto_rawDescOnce.Do(func() {
		file_SetAssistAvatarCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SetAssistAvatarCsReq_proto_rawDesc), len(file_SetAssistAvatarCsReq_proto_rawDesc)))
	})
...
var file_SetAssistAvatarCsReq_proto_goTypes = []any{
	(*SetAssistAvatarCsReq)(nil), // 0: emu.lunarcore.proto.SetAssistAvatarCsReq
}
...
func file_SetAssistAvatarCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SetAssistAvatarCsReq_proto_rawDesc), len(file_SetAssistAvatarCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
