...
const file_GetAssistHistoryCsReq_proto_rawDesc = "" +
	"\n" +
	"\x1bGetAssistHistoryCsReq.proto\x12\x13emu.lunarcore.proto\"\x17\n" +
	"\x15GetAssistHistoryCsReqB>\n" +
...
var (
	...
	file_GetAssistHistoryCsReq_proto_rawDescData []byte
)

func file_GetAssistHistoryCsReq_proto_rawDescGZIP() []byte {
	file_GetAssistHistoryCsReq_proto_rawDescOnce.Do(func() {
		file_GetAssistHistoryCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_GetAssistHistoryCsReq_proto_rawDesc), len(file_GetAssistHistoryCsReq_proto_rawDesc)))
	})
...
var file_GetAssistHistoryCsReq_proto_goTypes = []any{
	(*GetAssistHistoryCsReq)(nil), // 0: emu.lunarcore.proto.GetAssistHistoryCsReq
}
...
func file_GetAssistHistoryCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_GetAssistHistoryCsReq_proto_rawDesc), len(file_GetAssistHistoryCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
