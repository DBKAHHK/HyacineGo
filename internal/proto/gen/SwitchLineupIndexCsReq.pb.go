...
const file_SwitchLineupIndexCsReq_proto_rawDesc = "" +
	"\n" +
	"\x1cSwitchLineupIndexCsReq.proto\x12\x13emu.lunarcore.proto\".\n" +
	"\x16SwitchLineupIndexCsReq\x12\x14\n" +
	"\x05index\x18\b \x01(\rR\x05indexB>\n" +
...
var (
	...
	file_SwitchLineupIndexCsReq_proto_rawDescData []byte
)

func file_SwitchLineupIndexCsReq_proto_rawDescGZIP() []byte {
	file_SwitchLineupIndexCsReq_proto_rawDescOnce.Do(func() {
		file_SwitchLineupIndexCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SwitchLineupIndexCsReq_proto_rawDesc), len(file_SwitchLineupIndexCsReq_proto_rawDesc)))
	})
...
var file_SwitchLineupIndexCsReq_proto_goTypes = []any{
	(*SwitchLineupIndexCsReq)(nil), // 0: emu.lunarcore.proto.SwitchLineupIndexCsReq
}
...
func file_SwitchLineupIndexCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SwitchLineupIndexCsReq_proto_rawDesc), len(file_SwitchLineupIndexCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
