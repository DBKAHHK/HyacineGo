...
const file_StartFinishMainMissionScNotify_proto_rawDesc = "" +
	"\n" +
	"$StartFinishMainMissionScNotify.proto\x12\x13emu.lunarcore.proto\"H\n" +
	"\x1eStartFinishMainMissionScNotify\x12&\n" +
	"\x0fmain_mission_id\x18\x01 \x01(\rR\rmainMissionIdB>\n" +
...
var (
	...
	file_StartFinishMainMissionScNotify_proto_rawDescData []byte
)
...
func file_StartFinishMainMissionScNotify_proto_rawDescGZIP() []byte {
	file_StartFinishMainMissionScNotify_proto_rawDescOnce.Do(func() {
		file_StartFinishMainMissionScNotify_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_StartFinishMainMissionScNotify_proto_rawDesc), len(file_StartFinishMainMissionScNotify_proto_rawDesc)))
	})
...
var file_StartFinishMainMissionScNotify_proto_goTypes = []any{
	(*StartFinishMainMissionScNotify)(nil), // 0: emu.lunarcore.proto.StartFinishMainMissionScNotify
}
...
func file_StartFinishMainMissionScNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_StartFinishMainMissionScNotify_proto_rawDesc), len(file_StartFinishMainMissionScNotify_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
