...
const file_SceneCastSkillMpUpdateScNotify_proto_rawDesc = "" +
	"\n" +
	"$SceneCastSkillMpUpdateScNotify.proto\x12\x13emu.lunarcore.proto\"V\n" +
	"\x1eSceneCastSkillMpUpdateScNotify\x12$\n" +
	"\x0ecast_entity_id\x18\x03 \x01(\rR\fcastEntityId\x12\x0e\n" +
	"\x02mp\x18\n" +
	" \x01(\rR\x02mpB>\n" +
...
var (
	...
	file_SceneCastSkillMpUpdateScNotify_proto_rawDescData []byte
)
...
func file_SceneCastSkillMpUpdateScNotify_proto_rawDescGZIP() []byte {
	file_SceneCastSkillMpUpdateScNotify_proto_rawDescOnce.Do(func() {
		file_SceneCastSkillMpUpdateScNotify_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SceneCastSkillMpUpdateScNotify_proto_rawDesc), len(file_SceneCastSkillMpUpdateScNotify_proto_rawDesc)))
	})
...
var file_SceneCastSkillMpUpdateScNotify_proto_goTypes = []any{
	(*SceneCastSkillMpUpdateScNotify)(nil), // 0: emu.lunarcore.proto.SceneCastSkillMpUpdateScNotify
}
...
func file_SceneCastSkillMpUpdateScNotify_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SceneCastSkillMpUpdateScNotify_proto_rawDesc), len(file_SceneCastSkillMpUpdateScNotify_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
