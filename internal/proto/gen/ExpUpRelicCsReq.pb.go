...
const file_ExpUpRelicCsReq_proto_rawDesc = "" +
	"\n" +
	"\x15ExpUpRelicCsReq.proto\x12\x13emu.lunarcore.proto\x1a\x12ItemCostData.proto\"y\n" +
	"\x0fExpUpRelicCsReq\x12&\n" +
	"\x0frelic_unique_id\x18\x05 \x01(\rR\rrelicUniqueId\x12>\n" +
	"\tcost_data\x18\t \x01(\v2!.emu.lunarcore.proto.ItemCostDataR\bcostDataB>\n" +
...
var (
	...
	file_ExpUpRelicCsReq_proto_rawDescData []byte
)

func file_ExpUpRelicCsReq_proto_rawDescGZIP() []byte {
	file_ExpUpRelicCsReq_proto_rawDescOnce.Do(func() {
		file_ExpUpRelicCsReq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ExpUpRelicCsReq_proto_rawDesc), len(file_ExpUpRelicCsReq_proto_rawDesc)))
	})
	return file_ExpUpRelicCsReq_proto_rawDescData
}

var file_ExpUpRelicCsReq_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ExpUpRelicCsReq_proto_goTypes = []any{
	(*ExpUpRelicCsReq)(nil), // 0: emu.lunarcore.proto.ExpUpRelicCsReq
	(*ItemCostData)(nil),    // 1: emu.lunarcore.proto.ItemCostData
}
var file_ExpUpRelicCsReq_proto_depIdxs = []int32{
	1, // 0: emu.lunarcore.proto.ExpUpRelicCsReq.cost_data:type_name -> emu.lunarcore.proto.ItemCostData
...
func file_ExpUpRelicCsReq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ExpUpRelicCsReq_proto_rawDesc), len(file_ExpUpRelicCsReq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
