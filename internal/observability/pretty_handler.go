...
func (h *prettyHandlerWithAttrs) Enabled(ctx context.Context, level slog.Level) bool { return h.base.Enabled(ctx, level) }
...
func (h *prettyHandlerWithGroup) Enabled(ctx context.Context, level slog.Level) bool { return h.base.Enabled(ctx, level) }
func (h *prettyHandlerWithGroup) WithAttrs(attrs []slog.Attr) slog.Handler         { return h.base.WithAttrs(attrs) }
